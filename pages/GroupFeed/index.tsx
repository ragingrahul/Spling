                ...
                <div className=' flex flex-col w-[960px] h-fit ml-28'>
                    <div className='bg-slate-200 text-[#565656] flex flex-row rounded-b-3xl p-7'>
                        ...
                        <div className="flex flex-row w-1/2 justify-end">
                            <div className="flex flex-col items-end justify-around mr-[20px] px-[10px] pl-[80px] bg-[#A0D8EF] rounded-2xl hover:cursor-pointer" onClick={() => window.location.href=`./Dashboard/${userInfo?.userId}`}>
                            ...
                            {userInfo?.avatar ? <img
                                src={userInfo?.avatar}
                                alt="avatar"
                                className='rounded-full h-[80px] w-[80px] border-4 border-[#A0D8EF] hover:cursor-pointer' onClick={() => window.location.href=`./Dashboard/${userInfo?.userId}`}
                            /> :
                                <img src='/ProfilePic.png' alt='ProfilePic' className='rounded-full h-[80px] w-[80px] border-4 border-[#A0D8EF] hover:cursor-pointer' onClick={() => window.location.href=`./Dashboard/${userInfo?.userId}`}/>
                            }
                        </div>
                    </div>
                    <div className='w-[100%] h-[25.2rem] bg-slate-200 rounded-2xl flex flex-col mt-5 mb-1'>
                        ...
                        <div className='flex flex-row w-[100%] h-72'>
                            {bio?.Cardio && <div className='bg-[#565656] rounded-2xl w-[25%] h-[100%]  ml-7'>
                                <button className='h-[100%] w-[100%] bg-gray-800 opacity-100  rounded-2xl' onClick={()=>setCategory(15)}>
                                    <div className='overflow-hidden relative h-[100%] w-[100%]'>
                                        <img src='/Cardio.jpg' className='transition ease-in h-full w-full rounded-2xl opacity-30 hover:opacity-70'></img>
                                        <h1 className=' absolute text-red-100 w-full bottom-3 font-[Chillax] text-2xl '>Cardio</h1>
                                    </div>
                                </button>
                            </div>}
                            {bio?.Weight && <div className='bg-[#565656] rounded-2xl w-[25%] h-[100%]  ml-7'>
                                <button className='h-[100%] w-[100%] bg-gray-800 opacity-100  rounded-2xl' onClick={()=>setCategory(16)}>
                                    <div className='overflow-hidden relative h-[100%] w-[100%]'>
                                        <img src='/Weight.jpg' className='transition ease-in h-full w-full rounded-2xl opacity-30 hover:opacity-70'></img>
                                        <h1 className=' absolute text-red-100 w-full bottom-3 font-[Chillax] text-2xl '>Weight Training</h1>
                                    </div>
                                </button>
                            </div>}
                            {bio?.Yoga && <div className='bg-[#565656] rounded-2xl w-[25%] h-[100%]  ml-7'>
                                <button className='h-[100%] w-[100%] bg-gray-800 opacity-100  rounded-2xl' onClick={()=>setCategory(17)}>
                                    <div className='overflow-hidden relative h-[100%] w-[100%]'>
                                        <img src='/Yoga.jpg' className='transition ease-in h-full w-full rounded-2xl opacity-30 hover:opacity-70'></img>
                                        <h1 className=' absolute text-red-100 w-full bottom-3 font-[Chillax] text-2xl '>Yoga</h1>
                                    </div>
                                </button>
                            </div>}
                        </div>
